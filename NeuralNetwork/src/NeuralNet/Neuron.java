 ...
 * in the network which it will then pass to next layers in the future
 * There are 4 types of Neurons: Input, Hidden, Output, and Bias Neurons
 * 
 * Input Neurons are the values that are determined by the user and are set at the beginning of 
 * each test. They are responsible for sending outputs to the next layer
 * 
 ...
 * previous layer, AND output their value to the next layer
 * 
 ...
 * between 0 and 1, Bias Neurons always contain a value of 1.
 * 
